...
public class UserRegisterService {
    ...
    public ResultData registerSystemSuperUser(RegisterUserBean registerUserBean) {
    ...
    public ResultData registerSystemUser(RegisterUserBean registerUserBean) {
    ...
    public ResultData registerAdmin(RegisterUserBean registerUserBean){
    ...
    public ResultData registerSuperUser(RegisterUserBean registerUserBean){
        String groupDescription = registerUserBean.getGroupDescription();
        UserGroupDao userGroupDao = userGroupMapper.queryGroupByDescription(groupDescription);
    ...
    public ResultData registerUser(RegisterUserBean registerUserBean){
        String groupDescription = registerUserBean.getGroupDescription();
        UserGroupDao userGroupDao = userGroupMapper.queryGroupByDescription(groupDescription);
     ...
     * @return
     */
    public ResultData register(RegisterUserBean registerUserBean, int groupId, int roleId){
