 ...
 */
@RestController
public class TestItemTypeController extends BaseController<TestItemTypeServiceImpl, TestItemTypeDao>{
    ...
    public ResultData<List<TestItemTypeDao>> testItemType(@RequestBody TestItemTypeDao dao,
