 ...
 */
@RestController
public class ChemistryContrastController extends BaseController<ChemistryContrastServiceImpl, ChemistryContrastDao>{
    ...
    public ResultData<List<ChemistryContrastDao>> chemistryContrast(@RequestBody ChemistryContrastDao dao,
        ...
        queryWrapper = new QueryWrapper<ChemistryContrastDao>()
