 ...
 */
@RestController
public class RuleTypeController extends BaseController<RuleTypeServiceImpl, RuleTypeDao>{
    ...
    public ResultData<List<RuleTypeDao>> ruleType(@RequestBody RuleTypeDao dao,
