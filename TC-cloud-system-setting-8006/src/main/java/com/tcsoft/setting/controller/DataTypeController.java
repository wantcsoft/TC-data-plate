 ...
 */
@RestController
public class DataTypeController extends BaseController<DataTypeServiceImpl, DataTypeDao> {
    ...
    public ResultData<List<DataTypeDao>> dataType(@RequestBody DataTypeDao dao,
