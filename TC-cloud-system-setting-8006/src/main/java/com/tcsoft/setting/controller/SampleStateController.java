 ...
 */
@RestController
public class SampleStateController extends BaseController<SampleStateServiceImpl, SampleStateDao>{
    ...
    public ResultData<List<SampleStateDao>> sampleState(@RequestBody SampleStateDao dao,
